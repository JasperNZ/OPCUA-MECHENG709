# README
#
# This is the source code for the Company1 Client.
#
...
try:
    ...
    Client1_progress_file = open("Group_{}_Progress_Client_1.txt".format(assignment_group_number), "w")

    # Create file instance for client 1 Machine Status file
    Client1_Machine_status_file = open("Group_{}_Machine_Status_Client_1.txt".format(assignment_group_number), "w")

    # Connect to server
    client.connect()
    # log data
    with open("Group_{}_Progress_Client_1.txt".format(assignment_group_number), "a") as f:
...
# log data
with open("Group_{}_Machine_Status_Client_1.txt".format(assignment_group_number), "a") as f:
    f.write(
...
Start_Kuka_Prog1 =  method[3]          # TODO: Get a reference to the 'Start_Kuka_Prog1' method node
Start_Lathe_Prog1 = method[4]          # TODO: Get a reference to the 'Start_Lathe_Prog1' method node
Start_Lathe_Prog2 = method[5]          # TODO: Get a reference to the 'Start_Lathe_Prog2' method node
#############################################################################################
...
# Get the completion date and time
completion_datetime = datetime.now().strftime("%Y-%m-%d %H:%M:%S")  # Full date and time

# Print and log the program completion information
operation_order = ", ".join(Company_1_operation_list)
completion_message = f"Program completed for Group {assignment_group_number} on {completion_datetime}. Operations executed: {operation_order}"
