# README
#
# This is the source code for the Company2 Client.
#
...
try:
    ...
    Client2_progress_file = open("Group_{}_Progress_Client_2.txt".format(assignment_group_number), "w")

    # Create file instance for client 2 Machine Status file
    Client1_Machine_status_file = open("Group_{}_Machine_Status_Client_2.txt".format(assignment_group_number), "w")

    # Connect to server
    client.connect()

    # log data
    with open("Group_{}_Progress_Client_2.txt".format(assignment_group_number), "a") as f:
...
# log data
with open("Group_{}_Machine_Status_Client_2.txt".format(assignment_group_number), "a") as f:
    f.write(
...
operation_order = ", ".join(Company_2_operation_list)
