...
# You can add new lines in the Server Code for diagnostic purposes, such as getting or printing node information.

# Please do not modify any of the existing lines of code!!!!!!!!!!
...
TimeStamp = param.add_variable(addSpace, "Time_Stamp", "null")
...
# Get Node ID for 'Equipment_ID1'
print(f"Equipment_ID1 Node ID: {Equipment_ID1}")

# Get Browse Name of Node 'Equipment_ID1'
Equipment_ID1_BrowseName = Equipment_ID1.get_browse_name()
print(f"Equipment_ID1 Browse Name: {Equipment_ID1_BrowseName}")

# Get Value of Node 'Equipment_ID1'
Equipment_ID1_Value = Equipment_ID1.get_value()
print(f"Equipment_ID1 Value: {Equipment_ID1_Value}")
